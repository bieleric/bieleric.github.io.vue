    ...
    <BaseLayout :onscroll="scrollHandler">
        ...
        <PageLayout id="2" ref="page2" class="flex flex-col justify-center items-center">
            ...
            <div class="flex justify-evenly md:w-1/2 w-3/4 font-thin mt-8 text-3xl">
                <a href="https://linkedin.com/in/eric-biele-ba9163185" target="_blank" v-motion
                    :initial="{ scale: 0 }"
                    :visible-once="{ 
                        scale: 1,
                        transition: {
                ...
                <a href="https://github.com/bieleric" target="_blank" v-motion
                    :initial="{ scale: 0 }"
                    :visible-once="{ 
                        scale: 1,
                        transition: {
        ...
        <PageLayout id="3" ref="page3" class="flex flex-col justify-center items-center">
            ...
            <div class="w-10/12 md:w-3/4 xl:w-1/2 grid md:grid-cols-3 grid-cols-2 gap-4">
                <ProjectLink v-motion
                    ...
                    :projectName="$t('projects.idenlight.title')" 
                    :shortDescription="$t('projects.idenlight.shortDescription')" 
                    :linkName="$t('projects.idenlight.linkName')" 
                    :image="$t('projects.idenlight.image')" />
                <ProjectLink v-motion
                    :initial="{ scale: 0 }"
                    :visible-once="{ 
                        scale: 1,
                    ...
                    :projectName="$t('projects.webxplorer.title')" 
                    :shortDescription="$t('projects.webxplorer.shortDescription')" 
                    :linkName="$t('projects.webxplorer.linkName')" 
                    :image="$t('projects.webxplorer.image')" />
                <ProjectLink v-motion
                    :initial="{ scale: 0 }"
                    :visible-once="{ 
                        scale: 1,
                    ...
                    :projectName="$t('projects.bib-desk.title')" 
                    :shortDescription="$t('projects.bib-desk.shortDescription')" 
                    :linkName="$t('projects.bib-desk.linkName')" 
                    :image="$t('projects.bib-desk.image')" />
            </div>
        </PageLayout>
    </BaseLayout>
</template>